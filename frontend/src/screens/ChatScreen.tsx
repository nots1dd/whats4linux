  ...
  return (
    <div className="flex h-screen bg-light-secondary dark:bg-black overflow-hidden">
        ...
        <div className="p-2 bg-white dark:bg-black border-b border-gray-200 dark:border-dark-tertiary">
          <div className="bg-light-secondary dark:bg-dark-tertiary rounded-lg flex items-center px-4 py-2">
            <svg
              ...
              fill="currentColor"
            >
              <path d="M15.009 13.805h-.636l-.22-.219a5.184 5.184 0 0 0 1.256-3.41c0-2.877-2.332-5.207-5.207-5.207-2.876 0-5.208 2.33-5.208 5.207 0 2.876 2.332 5.208 5.208 5.208 1.341 0 2.568-.516 3.487-1.363l.215.215v.627l4.002 3.999 1.196-1.196-4.093-4.092zm-4.809 0c-1.711 0-3.097-1.386-3.097-3.097 0-1.711 1.386-3.097 3.097-3.097 1.711 0 3.097 1.386 3.097 3.097 0 1.711-1.386 3.097-3.097 3.097z"></path>
            </svg>
            <input
              type="text"
      ...
      <div
        ...
        } flex-1 flex-col h-full bg-[#efeae2] dark:bg-dark-secondary relative`}
      >
        {selectedChatId ? (
          <ChatDetail
